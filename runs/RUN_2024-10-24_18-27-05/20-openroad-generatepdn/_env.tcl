set ::env(FP_PDN_CFG) /nix/store/ly8g3mcmscy67krhznzmkhbdvmqi6y4d-python3-3.11.9-env/lib/python3.11/site-packages/openlane/scripts/openroad/common/pdn_cfg.tcl
...
set ::env(CURRENT_ODB) /local/proj/swanson/revA0/digital/tristate_test/runs/RUN_2024-10-24_18-27-05/18-openroad-tapendcapinsertion/tristate_test.odb
set ::env(SAVE_ODB) /local/proj/swanson/revA0/digital/tristate_test/runs/RUN_2024-10-24_18-27-05/20-openroad-generatepdn/tristate_test.odb
set ::env(SAVE_DEF) /local/proj/swanson/revA0/digital/tristate_test/runs/RUN_2024-10-24_18-27-05/20-openroad-generatepdn/tristate_test.def
set ::env(SAVE_SDC) /local/proj/swanson/revA0/digital/tristate_test/runs/RUN_2024-10-24_18-27-05/20-openroad-generatepdn/tristate_test.sdc
set ::env(SAVE_NETLIST) /local/proj/swanson/revA0/digital/tristate_test/runs/RUN_2024-10-24_18-27-05/20-openroad-generatepdn/tristate_test.nl.v
set ::env(SAVE_POWERED_NETLIST) /local/proj/swanson/revA0/digital/tristate_test/runs/RUN_2024-10-24_18-27-05/20-openroad-generatepdn/tristate_test.pnl.v
