set ::env(TRACKS_INFO_FILE_PROCESSED) /local/proj/swanson/revA0/digital/tristate_test/runs/RUN_2024-10-24_18-27-05/13-openroad-floorplan/config.tracks
...
set ::env(DESIGN_NAME) tristate_test
set ::env(CLOCK_PERIOD) 10
set ::env(CLOCK_PORT) ""
set ::env(DIE_AREA) "0 0 100 100"
set ::env(FALLBACK_SDC_FILE) /nix/store/ly8g3mcmscy67krhznzmkhbdvmqi6y4d-python3-3.11.9-env/lib/python3.11/site-packages/openlane/scripts/base.sdc
set ::env(PDN_CONNECT_MACROS_TO_GRID) 1
set ::env(PDN_ENABLE_GLOBAL_CONNECTIONS) 1
set ::env(FP_SIZING) absolute
set ::env(FP_ASPECT_RATIO) 1
set ::env(FP_CORE_UTIL) 50
set ::env(CORE_AREA) "30 30 70 70"
set ::env(BOTTOM_MARGIN_MULT) 4
set ::env(TOP_MARGIN_MULT) 4
set ::env(LEFT_MARGIN_MULT) 12
set ::env(RIGHT_MARGIN_MULT) 12
set ::env(CURRENT_NETLIST) /local/proj/swanson/revA0/digital/tristate_test/runs/RUN_2024-10-24_18-27-05/06-yosys-synthesis/tristate_test.nl.v
set ::env(SAVE_ODB) /local/proj/swanson/revA0/digital/tristate_test/runs/RUN_2024-10-24_18-27-05/13-openroad-floorplan/tristate_test.odb
set ::env(SAVE_DEF) /local/proj/swanson/revA0/digital/tristate_test/runs/RUN_2024-10-24_18-27-05/13-openroad-floorplan/tristate_test.def
set ::env(SAVE_SDC) /local/proj/swanson/revA0/digital/tristate_test/runs/RUN_2024-10-24_18-27-05/13-openroad-floorplan/tristate_test.sdc
set ::env(SAVE_NETLIST) /local/proj/swanson/revA0/digital/tristate_test/runs/RUN_2024-10-24_18-27-05/13-openroad-floorplan/tristate_test.nl.v
set ::env(SAVE_POWERED_NETLIST) /local/proj/swanson/revA0/digital/tristate_test/runs/RUN_2024-10-24_18-27-05/13-openroad-floorplan/tristate_test.pnl.v
