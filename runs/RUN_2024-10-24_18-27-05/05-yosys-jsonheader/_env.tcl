...
set ::env(VERILOG_FILES) /local/proj/swanson/revA0/digital/tristate_test/tristate_test.v
set ::env(VERILOG_POWER_DEFINE) USE_POWER_PINS
set ::env(USE_SYNLIG) 0
set ::env(SYNLIG_DEFER) 0
set ::env(SAVE_JSON_HEADER) /local/proj/swanson/revA0/digital/tristate_test/runs/RUN_2024-10-24_18-27-05/05-yosys-jsonheader/tristate_test.h.json
